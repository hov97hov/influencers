<template>
    <div class="search-result">
        ...
        <div class="items">
            ...
            >
                <a :href="user.twitter.profile_url" target="_blank" class="text-decoration-none">
                    <div class="left-section">
                        ...
                        <div>
                            ...
                            <div class="sub-name">{{user.twitter.username}}</div>
                        </div>
                    </div>
                </a>
                ...
                <div class="center-section">
                    ...
                    <div>{{ user.twitter.follow | formatNumber }}</div>
                    <div>{{ user.twitter.post_count | formatNumber }}</div>
            ...
            >
                <div class="left-section">
                    <a :href="user.twitter.profile_url" target="_blank" class="text-decoration-none">
                        <img :src="user.twitter.image" :alt="user.twitter.full_name">
                        <div>
                            <div class="name">{{user.twitter.full_name}}
                                <img v-if="user.user_detail.account_type" src="/images/icons/done.png" alt="">
                            </div>
                            <div class="sub-name">{{user.twitter.username}}</div>
                        </div>
                ...
                <div class="center-section">
                    ...
                    <div><img src="/images/icons/Icon-color3.png" alt=""><span>{{ user.twitter.follow | formatNumber  }}</span></div>
                    <div><img src="/images/icons/Icon-color5.png" alt=""><span>{{ user.twitter.post_count | formatNumber }}</span></div>
                </div>
