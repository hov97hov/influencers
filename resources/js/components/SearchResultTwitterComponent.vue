        ...
        <div class="items">
            ...
            >
                ...
                <div class="center-section">
                    ...
                    <div>{{ user.twitter.follow }}</div>
                    <div>{{ user.twitter.post_count }}</div>
        ...
        <div class="items-mobile">
            ...
            >
                ...
                <div class="center-section">
                    ...
                    <div><img src="/images/icons/Icon-color3.png" alt=""><span>{{ user.twitter.follow }}</span></div>
                    <div><img src="/images/icons/Icon-color5.png" alt=""><span>{{ user.twitter.post_count }}</span></div>
                </div>
