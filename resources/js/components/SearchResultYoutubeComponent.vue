<template>
    <div class="search-result">
        ...
        <div class="items">
            ...
            >
                <a :href="user.youtube.profile_url" target="_blank" class="text-decoration-none">
                    <div class="left-section">
                        <img :src="user.youtube.image" :alt="user.youtube.full_name">
                        <div>
                            <div class="name">
                                {{user.youtube.full_name}}
                                <img v-if="user.user_detail.account_type" src="/images/icons/done.png" alt="">
                            </div>
                            <div class="sub-name">{{user.youtube.username}}</div>
                        </div>
                    </div>
                </a>
            ...
            >
                <div class="left-section">
                    <a :href="user.youtube.profile_url" target="_blank" class="text-decoration-none">
                        <img :src="user.youtube.image" :alt="user.youtube.full_name">
                        <div>
                            <div class="name">{{user.youtube.full_name}}
                                <img v-if="user.user_detail.account_type" src="/images/icons/done.png" alt="">
                            </div>
                            <div class="sub-name">{{user.youtube.username}}</div>
                        </div>
