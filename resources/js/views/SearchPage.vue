                ...
                <div class="input-filter-content">
                    ...
                    <div class="items">
                        <div class="fields">
                            <div>
                                <p>Platform</p>
                                <button class="select-btn" @click="transitionPlatform = !transitionPlatform">
                                    <img :class="{active : transitionPlatform}" src="/images/icons/dropdown.svg" alt="">
                                </button>
                                <transition name="slide">
                                    <div class="transition-select" v-if="transitionPlatform">
                            ...
                            <div>
                                <p>Category</p>
                                <button class="select-btn" @click="transitionCategory = !transitionCategory">
                                    <img :class="{active : transitionCategory}" src="/images/icons/dropdown.svg" alt="">
                                </button>
                                <transition name="slide">
                                    <div class="transition-select" v-if="transitionCategory">
                                        <div class="search-category-content">
                                            <input class="search-input" type="text" placeholder="Choose category">
                                        </div>
                                        <div class="selected-category-content">
                            ...
                            <div>
                                ...
                                <button class="select-btn" @click="numberFollowers = !numberFollowers">
                                    <img :class="{active : numberFollowers}" src="/images/icons/dropdown.svg" alt="">
                                </button>
                                <transition name="slide">
                                    <div class="transition-select" v-if="numberFollowers">
